...
export const CartSlice=createSlice({
    ...
    reducers:{
        addItems:(state,action)=>{
            let checkProductExisted=state.items.filter((eachItem)=>(eachItem.id===action.payload.id));
        ...
        decreaseCount:(state,action)=>{
            let currentCounterValue=state.items.filter((eachItem)=>(eachItem.id===action.payload))
...
export const{addItems,removeItems,increaseCount,decreaseCount}=CartSlice.actions;
